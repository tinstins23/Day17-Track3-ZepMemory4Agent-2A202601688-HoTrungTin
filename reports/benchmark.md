...
- Average retrieval latency: **809.6 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 858.8 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1321.2 | 775 | 0.0% |  |
| E10 | short_term | PASS | 0.4 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1321.1 | 1528 | 0.0% |  |
| E03 | long_term | PASS | 1473.0 | 1524 | 0.0% |  |
| E04 | episodic | PASS | 270.9 | 284 | 0.0% |  |
| E05 | episodic | PASS | 255.7 | 303 | 0.0% |  |
| E07 | mixed | PASS | 1743.9 | 485 | 14.2% |  |
| E11 | semantic | PASS | 255.5 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1405.3 | 1516 | 0.0% |  |
...
`<USER_SUMMARY> For personal demos like ORCHID-27, the user prefers Python. However, for the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project.  The user likes Python and dislikes Java. They are learning about async/await and often confuse coroutine with Task, requesting explanations using timelines for these concepts. The user also prefers short code examples when explaining code. A suggested solution involves reusing an aiohttp ClientSession and setting concurrency to 20, with the reflection that the main error is connection churn, not timeout threshold. The user's personal project is named ORCHID-27. They have a deadline`
...
`<LONG_TERM> <USER_SUMMARY> For personal demos like ORCHID-27, the user prefers Python. However, for the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project.  The user likes Python and dislikes Java. They are learning about async/await and often confuse coroutine with Task, requesting explanations using timelines for these concepts. The user also prefers short code examples when explaining code. A suggested solution involves reusing an aiohttp ClientSession and setting concurrency to 20, with the reflection that the main error is connection churn, not timeout threshold. The user's personal project is named ORCHID-27. They hav`
